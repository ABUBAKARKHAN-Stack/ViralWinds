                    ...
                    <div className="relative z-10">
                        ...
                        >
                            <AnimatedBadge className="inline-flex items-center gap-2 bg-accent/10 border border-accent/20 rounded-full px-4 py-2 mb-8">
                                ...
                                <span className="text-accent text-sm font-medium tracking-wide">{cta?.badgeText || "Ready to get started?"}</span>
                            </AnimatedBadge>
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 lg:gap-12">
                            <div className="space-y-6 max-w-2xl">
                                ...
                                >
                                    {
                                        (() => {
                                            const words = cta?.title?.split(" ") || "Let's create something extraordinary".split(" ");
                                ...
                                >
                                    <LinkProcessor
                                        text={cta?.description || "We'd love to hear about your project and explore how we can help bring your vision to life. Let's start a conversation."}
                                    />
                                </motion.p>
                            </div>
                            ...
                            >
                                ...
                                >
                                    <span className="relative z-10 group-hover:text-primary-foreground">{cta?.buttonText || "Get in touch"}</span>
                                    <ArrowUpRight className="relative group-hover:text-primary-foreground z-10 h-5 w-5 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-200" />
