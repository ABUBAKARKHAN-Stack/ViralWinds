...
import { getDashboardProjects } from "@/app/actions/project"
        ...
        <div className="space-y-6 container mx-auto pb-10">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div className="space-y-1">
                    <h1 className="text-3xl font-bold tracking-tight text-foreground">Portfolio Management</h1>
                    <p className="text-muted-foreground text-sm">Create, edit and manage your projects and case studies.</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card className="bg-card shadow-sm border overflow-hidden">
                    <CardContent className="p-4 flex flex-col gap-1">
                        ...
                        <div className="flex items-end justify-between">
                            <span className="text-3xl font-black text-foreground leading-none">{projects.length}</span>
                ...
                <Card className="bg-card shadow-sm border overflow-hidden">
                    <CardContent className="p-4 flex flex-col gap-1">
                        ...
                        <div className="flex items-end justify-between">
                            <span className="text-3xl font-black text-foreground leading-none">{projects.filter(p => p.status === 'Draft').length}</span>
                ...
                <Card className="bg-card shadow-sm border overflow-hidden">
                    <CardContent className="p-4 flex flex-col gap-1">
                        ...
                        <div className="flex items-end justify-between">
                            <span className="text-3xl font-black text-foreground leading-none">{projects.filter(p => p.status === 'Published').length}</span>
